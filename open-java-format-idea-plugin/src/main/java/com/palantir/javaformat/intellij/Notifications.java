...
class Notifications {
    ...
    static final String GENERIC_ERROR_NOTIFICATION_GROUP = "open-java-format error";
    static final String PARSING_ERROR_NOTIFICATION_GROUP = "open-java-format parsing error";
